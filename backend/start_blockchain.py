...
def main():
    ...
    if missing_vars:
        print("\n⚠️ Există variabile de mediu lipsă, dar putem continua oricum.")

    print("\n✅ Blockchain și contracte deployate cu succes!")
    print("Blockchain-ul rulează acum pe http://localhost:8545")
    print("Pentru a opri blockchain-ul, apasă CTRL+C")
